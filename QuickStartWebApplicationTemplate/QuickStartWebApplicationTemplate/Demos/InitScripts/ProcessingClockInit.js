...
require.config({
    ...
    paths: {
        ...
        'clock': '../Demos/InitScripts/ProcessingSketches/Clock'
    },
    shim: {
        'underscore': {
            exports: '_'
...
require(['jquery', 'knockout', 'underscore', 'util', 'processing', 'clock',
    'domReady!'
    ], function ($, ko, _, util, Processing, clockSketch) {
        ...
        var processingInstance = new Processing(canvas, clockSketch);
